...
const char* ASTRONAUT_MEDIAN_FILTER_WINDOW_NAME = "Austronaut - Median filter";
...
int main(int argc, char** argv)
{
    ...
    cv::Mat austronaut_median(astronaut_grayscale.rows, astronaut_grayscale.cols, CV_8UC1);
    median_filter(astronaut_grayscale, austronaut_median, filter_size);
    cv::namedWindow(ASTRONAUT_MEDIAN_FILTER_WINDOW_NAME);
    cv::imshow(ASTRONAUT_MEDIAN_FILTER_WINDOW_NAME, austronaut_median);
    cv::waitKey(0);
